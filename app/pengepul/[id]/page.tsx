          ...
          {type === "pengepul" ? (
            <>
              <p>
                ...
                {(profile as PengepulProfile).companyName || "-"}
              </p>
              <p>
                <strong>Nomor Lisensi:</strong>{" "}
                {(profile as PengepulProfile).licenseNumber || "-"}
              </p>
              <p>
                <strong>Material:</strong>{" "}
                {(profile as PengepulProfile).specializedMaterials.join(", ")}
              </p>
              <p>
                <strong>Area Operasi:</strong>{" "}
                {(profile as PengepulProfile).operatingArea.join(", ")}
              </p>
              <p className="flex items-center gap-1">
                <Phone className="w-4 h-4" />
                <strong>WhatsApp:</strong>{" "}
                {(profile as PengepulProfile).whatsappNumber || "-"}
              </p>
            </>
          ) : (
            <>
              <p>
                ...
                {(profile as PengrajinProfile).craftType.join(", ")}
              </p>
              <p>
                <strong>Material:</strong>{" "}
                {(profile as PengrajinProfile).materials.join(", ")}
              </p>
              <p>
                <strong>Range Harga:</strong>{" "}
                {(profile as PengrajinProfile).priceRange || "-"}
              </p>
              <p className="flex items-center gap-1">
                <Phone className="w-4 h-4" />
                <strong>WhatsApp:</strong>{" "}
                {(profile as PengrajinProfile).whatsappNumber || "-"}
              </p>
            </>
          )}
          <p>
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-6">
                  ...
                  {type === "pengepul" ? (
                    <>
                      ...
                      <p>
                        ...
                        {(profile as PengepulProfile).workingHours || "-"}
                      </p>
                      <p>
                        <strong>Website:</strong>{" "}
                        {(profile as PengepulProfile).website || "-"}
                      </p>
                      <p>
                        <strong>WhatsApp:</strong>{" "}
                        {(profile as PengepulProfile).whatsappNumber || "-"}
                    ...
                    <>
                      ...
                      <p>
                        ...
                        {(profile as PengrajinProfile).instagramHandle || "-"}
                      </p>
                      <p>
                        <strong>WhatsApp:</strong>{" "}
                        {(profile as PengrajinProfile).whatsappNumber || "-"}
              ...
              {type === "pengrajin" &&
                (profile as PengrajinProfile).portfolio &&
                (profile as PengrajinProfile).portfolio.length > 0 && (
                  <div>
                    <h3 className="font-semibold mb-3">Portfolio</h3>
                    <div className="grid grid-cols-3 gap-3">
                      {(profile as PengrajinProfile).portfolio.map(
